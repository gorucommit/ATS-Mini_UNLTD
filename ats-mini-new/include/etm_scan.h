...
// (8750 = 87.5 MHz), so FM profile steps are also in 10 kHz units: 10 = 100 kHz, 5 = 50 kHz, etc.
inline constexpr EtmBandProfile kEtmProfileFm = {10, 5, 15, 55, 9};  // 100 kHz coarse, 50 kHz fine, ±150 kHz window, 90 kHz merge
