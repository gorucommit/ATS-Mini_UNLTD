...
inline constexpr uint32_t kMultiClickWindowMs = 500;
/// Layers where double/triple click are ignored: deliver single click immediately after debounce.
inline constexpr uint32_t kImmediateClickWindowMs = 0;
