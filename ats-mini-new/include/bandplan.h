...
inline constexpr BandDef kBandPlan[] = {
    ...
    {BandId::LW, "LW", 150, 300, 279, Modulation::AM, true},
    {BandId::MW, "MW", 300, 1800, 1000, Modulation::AM, true},
    {BandId::BC120m, "120m", 2200, 2600, 2400, Modulation::AM, true},
    {BandId::BC90m, "90m", 3000, 3600, 3300, Modulation::AM, true},
    {BandId::BC75m, "75m", 3700, 4200, 3950, Modulation::AM, true},
    {BandId::BC60m, "60m", 4500, 5300, 4900, Modulation::AM, true},
    {BandId::BC49m, "49m", 5600, 6700, 6000, Modulation::AM, true},
    {BandId::BC41m, "41m", 6800, 7800, 7300, Modulation::AM, true},
    {BandId::BC31m, "31m", 9000, 10100, 9600, Modulation::AM, true},
    {BandId::BC25m, "25m", 11300, 12500, 11850, Modulation::AM, true},
    {BandId::BC22m, "22m", 13300, 14200, 13650, Modulation::AM, true},
    {BandId::BC19m, "19m", 14800, 16200, 15450, Modulation::AM, true},
    {BandId::BC16m, "16m", 17100, 18300, 17650, Modulation::AM, true},
    {BandId::BC15m, "15m", 18600, 19400, 18950, Modulation::AM, true},
    {BandId::BC13m, "13m", 21200, 22200, 21650, Modulation::AM, true},
    {BandId::BC11m, "11m", 25200, 26400, 25850, Modulation::AM, true},
    {BandId::CB, "CB", 25000, 28000, 27135, Modulation::AM, true},
};
